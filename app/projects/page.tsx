...
export const metadata:Metadata={
  ...
  description:"Web Development using HTML , css, javascirpt , react ,redux , node ,nextjs",
  keywords:["HTML","CSS","Javascript","REactjs","Nextjs","Redux","Tailwind css"],
  authors:[
    {name:"subodh salve",url:"GITHUB Link"}
  ]
}
function page() {
  return (
